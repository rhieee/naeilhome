...
function deInputKo(e){
	if(!(e.keyCode >= 37 && e.keyCode <= 40)){
		...
		if(check1.test(inputName) || check2.test(inputName)){
			...
			console.log("InputMemberNameStatusCheck : " + InputMemberNameStatusCheck);
		}
		if(check.test(inputEmail) || check1.test(inputEmail) || check2.test(inputEmail) || check3.test(inputEmail)){
